    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if (u == "Fraction" || u == "fraction" || u == "FRACTION")
            {
                ...
                //The DIVISION of 2 fractions in overloading.
                ...
                //All comparisons of 2 fractions
                Console.WriteLine("--------All the comparisons of 2 fractions--------");
                //EQUAL and DIFFERENT?
                if (the1stfraction == the2ndfraction)
                {
                    Console.WriteLine($"{the1stfraction} is equal to {the2ndfraction}");
                }
                else if (the1stfraction != the2ndfraction)
                {
                    Console.WriteLine($"{the1stfraction} is different to {the2ndfraction}");
                }

                //GREATER and LESS THAN OR EQUAL?
                if (the1stfraction > the2ndfraction)
                {
                    Console.WriteLine($"{the1stfraction} is greater than {the2ndfraction}");
                }
                else if (the1stfraction <= the2ndfraction)
                {
                    Console.WriteLine($"{the1stfraction} is less than or equal to {the2ndfraction}");
                }

                //LESS and GREATER THAN OR EQUAL?
                if (the1stfraction < the2ndfraction)
                {
                    Console.WriteLine($"{the1stfraction} is less than {the2ndfraction}");
                }
                else if (the1stfraction >= the2ndfraction)
                {
                    Console.WriteLine($"{the1stfraction} is greater than or equal to {the2ndfraction}");
                }
            ...
            else if (u == "Mixed Fraction" || u == "mixed fraction" || u == "MIXED FRACTION")
            {
                ...
                //All comparisons of 2 mixed fractions (need help too :'>)
                Console.WriteLine("--------All the comparisons of 2 mixed fractions--------");
                //EQUAL and DIFFERENT?
                if (the1stMixedFraction == the2ndMixedFraction)
                {
                    Console.WriteLine($"{the1stMixedFraction} is equal to {the2ndMixedFraction}");
                }
                else if (the1stMixedFraction != the2ndMixedFraction)
                {
                    Console.WriteLine($"{the1stMixedFraction} is different to {the2ndMixedFraction}");
                }

                //GREATER and LESS THAN OR EQUAL?
                if (the1stMixedFraction > the2ndMixedFraction)
                {
                    Console.WriteLine($"{the1stMixedFraction} is greater than {the2ndMixedFraction}");
                }
                else if (the1stMixedFraction <= the2ndMixedFraction)
                {
                    Console.WriteLine($"{the2ndMixedFraction} is less than or equal to {the2ndMixedFraction}");
                }

                //LESS and GREATER THAN OR EQUAL?
                if (the1stMixedFraction < the2ndMixedFraction)
                {
                    Console.WriteLine($"{the1stMixedFraction} is less than {the2ndMixedFraction}");
                }
                else if (the1stMixedFraction >= the2ndMixedFraction)
                {
                    Console.WriteLine($"{the1stMixedFraction} is greater than or equal to {the2ndMixedFraction}");
                }
            }            
            Console.ReadKey();
        }
