...
namespace Testing17._1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Fraction.Addition(the1stfraction, the2ndfraction);
            Fraction.Subtraction(the1stfraction, the2ndfraction);
            Fraction.Multiplication(the1stfraction, the2ndfraction);
            Fraction.Division(the1stfraction, the2ndfraction);
